        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom col-xs-12">
            <ul class="nav nav-tabs">
              <li class="active" id="create_campaign"><a href="#createcampaign" data-toggle="tab">Create Campaign</a></li>
            </ul>
            <div class="tab-content">
              <div class="active tab-pane" id="createcampaign">
                <form id="create_new_campaign">
                  <div class='alert alert-success hidden' id="cmpgn-add-success">
                    <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Campaign Successfully Created!
                  </div>
                  <div class='alert alert-danger hidden' id="cmpgn-add-error">
                    <span class='glyphicon glyphicon-info-sign'></span> &nbsp; There was a problem with this action. Please contact IT immediately
                  </div>
                  <div class="form-group">
                    <label class="control-label" for="fromSubject">From:</label>
                    <input type="text" name="cmpngfrom" class="form-control" id="campaign-from" placeholder="i.e. David Saxe Productions">
                  </div> 
                  <div class="form-group">
                    <label class="control-label" for="fromSubject">Reply-To:</label>
                    <input type="email" class="form-control" name="cmpngreply" id="campaign-reply" placeholder="i.e. sales@davidsaxe.com">
                  </div>
                  <div class="form-group">
                    <label class="control-label" for="fromSubject">Title:</label>
                    <input type="text" class="form-control" name="cmpgntitle" id="campaign-title" placeholder="Title">
                  </div>
                  <div class="form-group">
                    <label class="control-label" for="fromSubject">Subject Line:</label>
                    <input type="text" class="form-control" name="cmpgnsubj" id="subject-line" placeholder="Subject Line">
                  </div> 
                  <div class="form-group">
                    <label class="control-label" for="fromSubject">Group To Send:</label>
                    <div class="checkbox">
                      <select class="form-control" id="segments" >
                      </select>
                    </div>
                  </div> 
                  <?php
                  echo "<a href=\"email-templates.php\" class=\"btn btn-default\"><i class=\"fa fa-angle-double-left\"></i> Back</a>"; ?>
                  <a id="btn-create-cmpgn" class="btn btn-primary pull-right">Add New</a>
                </form>
              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane" id="emailcontent">
                <form>
                  <div class="form-group">
                    <label for="form-editor" class="control-label">
                      HTML CODE FOR EMAIL TEMPLATE (EDITABLE ON MAILCHIMP)
                    </label>
                    <textarea name="editor1" id="editor1" rows="10" cols="80"></textarea>
                  </div>
                  <a href="#createcampaign" data-toggle="tab" class="btn btn-default">Previous</a>
                  <a href="#confirmation" data-toggle="tab" class="btn btn-primary pull-right">Next</a>
                </form>
              </div>
              <div class="tab-pane" id="confirmation">
                <form action="">
                  <div class="form-group">
                    <legend>
                      <fieldset><h1>Confirmation</h1></fieldset>
                    </legend>
                      <p>From:</p>
                      <p>Reply To:</p>
                      <p>Subject Line:</p>
                  ...
                  <a href="#emailcontent" data-toggle="tab" class="btn btn-default">Previous</a>
                  <button name="submit" id="submit" class="btn btn-primary pull-right">Submit</button>
                </form>
              </div>
              <!-- /.tab-pane -->
            </div>
...
<script type="text/javascript">
  ...
  .done(function(data) {
    ...
    for (var i = 0; i < raw.length; i++) {
      ...
      var id = raw[i].id;
      var segopt = '<option value=' + id + '>' + segment + '</option>';
      $(segopt).appendTo('#segments');
    }
    getSegments(segment,id);
  })
  .fail(function() {
    console.log("error");
  })
  ...
  function getSegments(segment,id)
  {
    $('#segments').select2 ({
