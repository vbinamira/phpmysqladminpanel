...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <?php 
      ...
      $user_role = PrivilegedUser::getByUsername($_SESSION['loggedin']);;
      if($user_role->hasPrivilege("Manage Users")) {
    ?>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="import-file.php"><i class="fa fa-circle-o"></i>Import File</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="shows.php">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Show List</h3>
              <div class="box-tools pull-right">
                <a href="add-show.php" class="btn btn-block btn-success btn-md"><i class="fa fa-plus"></i> Add New</a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="admin-shows" class="display" cellspacing="0" width="100%">
                  <thead>
                      <tr>
                          <th>ID</th>
                          <th>ShowID</th>
                  ...
                  <tfoot>
                    <tr>
                      <th></th>
                      <th></th>
                      <th><a class="disabled btn btn-md btn-warning" id="edit-show-btn"><i class="fa fa-edit"></i> Edit </a>
                      &nbsp
                      <a class="disabled btn btn-md btn-danger" id="delete-show-btn" data-toggle="modal" data-target="#deleteShowModal"><i class="fa fa-trash-o"></i> Delete</a><th>
                      <th></th>
                      <th></th>
                      <th></th>
                    </tr>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="cs-shows" class="display" cellspacing="0" width="100%">
                  <thead>
                      <tr>
                          <th>Show Name</th>
                          <th>Show Time</th>
  ...
  <div class="example-modal">
    <div class="modal" id="deleteShowModal">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="adm-show-rmv-msg">Are you sure you want to want to delete this show?</p>
            <div class='alert alert-success hidden' id="adm-show-rmv-success">
              <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Show Sucessfully Removed!
            </div>
            <div class='alert alert-danger hidden' id="adm-show-rmv-error">
          ...
          <div class="modal-footer">
            ...
            <a id="btn-delete-show" class="btn btn-primary">Delete</a>
          </div>
        </div>
      </div>
    </div>
