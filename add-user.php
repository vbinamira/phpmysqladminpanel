            ...
            <form class="form-horizontal" name="permissionForm" method="post">
              <div class="box-body">
                ...
                <div class="form-group has-feedback">
                  <label for="inputshname" class="col-sm-2 control-label">Full Name</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group has-feedback">
                  <label for="inputshtime" class="col-sm-2 control-label">Email</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group has-feedback">
                  <label for="inputshdate" class="col-sm-2 control-label">Password</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group has-feedback">
                  <label for="inputticket" class="col-sm-2 control-label">Confirm Password</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group has-feedback">
                  ...
                  <div class="col-sm-10">
                    <input name="company_name" id="company_name" type="text" class="form-control" placeholder="Name of Company">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group has-feedback">
