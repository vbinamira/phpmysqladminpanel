...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Priority List</h3>
              <div class="box-tools pull-right">
                <a href="add-priorities.php" class="btn btn-block btn-success btn-md"><i class="fa fa-plus"></i> Add New</a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="priority-list" class="display" cellspacing="0" width="100%">
                  <thead>
                      <tr>
                          <th>ID</th>
                          <th>Name</th>
                  ...
                  <tfoot>
                    <tr>
                      <th></th>
                      <th><a class="disabled btn btn-md btn-warning" id="edit-priority-btn"><i class="fa fa-edit"></i> Edit </a>
                      &nbsp
                      <a class="disabled btn btn-md btn-danger" id="delete-priority-btn" data-toggle="modal" data-target="#deletePriorityModal"><i class="fa fa-trash-o"></i> Delete</a><th>
                    </tr>
                  </tfoot>
              </table>
            </div>
  ...
  <div class="example-modal">
    <div class="modal" id="deletePriorityModal">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="prty-rmv-msg">Are you sure you want to want to delete this priority?</p>
            <div class='alert alert-success hidden' id="prty-rmv-success">
              <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Priority Sucessfully Removed!
            </div>
            <div class='alert alert-danger hidden' id="prty-rmv-error">
          ...
          <div class="modal-footer">
            ...
            <a id="btn-delete-priority" class="btn btn-primary">Delete</a>
          </div>
        </div>
      </div>
    </div>
