...
include ('includes/create-user-priority.php');
        ...
        <div class="col-sm-12 col-md-7">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Priority to a User</h3>
            </div>
            <form class="form-horizontal" name="permissionForm" method="post" >
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputrole" class="col-sm-2 control-label">Priority List</label>
                  <div class="col-sm-10">
                  <?php 
                    $user_role = new USER();
                    $stmt = $user_role->runQuery("SELECT usrpr_id, name FROM user_priorities");
                    $stmt->execute();
                    $stmt->bind_result($prtyid, $prtyname);
                    while($stmt->fetch()) {
                      echo "<div class=\"radio\">";
                      echo "<label>";
                      echo "<input type=\"radio\" name=priority[] id=priority_no.$prtyid value=$prtyid>$prtyname";
                      echo "</label>";
                      echo "</div>";
                    }
                    $stmt->close();
              ...
              <?php
                echo "<a href=\"edit-user.php?id=".$id."\" class=\"btn btn-default\"><i class=\"fa fa-angle-double-left\"></i> Back</a>"; ?>
