...
include 'includes/update-show.php';
            ...
            <form class="form-horizontal" name="permissionForm" method="post" >
              <div class="box-body">
                ...
                <div class="form-group has-feedback">
                  <label for="inputshname" class="col-sm-2 control-label">Show Name</label>
                  <div class="input-group input-append col-sm-10">
                    <input type="text" class="form-control" id="showname" name="showname" placeholder="Name of Show" value="<?php echo $shname;?>" required>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group has-feedback">
                  <label for="inputshtime" class="col-sm-2 control-label">Show Time</label>
                  <div class="input-group input-append col-sm-10">
                    <input type="text" class="editshowtime form-control" id="showtime" name="showtime" placeholder="Time" value="<?php echo $shtime;?>" required>
                    <span class="glyphicon glyphicon-time form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group has-feedback">
                  <label for="inputshdate" class="col-sm-2 control-label">Show Date</label>
                  <div class="input-group input-append col-sm-10">
                    <input type="date" class="form-control" id="showdate" name="showdate" placeholder="Date" value="<?php echo $shdate;?>" required>
                    <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group has-feedback">
                  <label for="inputticket" class="col-sm-2 control-label">Total Comps</label>
                  <div class="input-group input-append col-sm-10">
                    <input type="number" min="0" class="form-control" id="tickets" name="tickets" placeholder="No. of Tickets" value="<?php echo $ticket;?>" required>
