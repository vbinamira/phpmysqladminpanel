...
include 'includes/update-roles.php';
            ...
            <form class="form-horizontal" name="permissionForm" method="post" >
              <div class="box-body">
                ...
                <div class="form-group has-feedback" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="<?php echo $rname;?>" required>
              ...
              <div class="box-footer">
                <a href="roles.php" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>
