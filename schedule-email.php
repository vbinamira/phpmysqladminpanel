...
<head>
  ...
  <link rel="stylesheet" href="node_modules/admin-lte/plugins/timepicker/bootstrap-timepicker.min.css">
  <!-- DataTables -->
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Emails Schedule</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Scheduled Email Campaigns</h3>
            </div>
            <!-- /.box-header -->
            <?php if(isset($msg)){ echo $msg;}?> 
            <div class="box-body">
              <div class="table-responsive">
                <table id="scheduled-list" class="table table-hovered display" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th>ID</th>
                  ...
                  <tfoot>
                    <tr>
                      <th></th>
                      <th><a href="#" target="_blank" class="disabled btn btn-md btn-info" id="unsched-preview-template"><i class="fa fa-picture-o"></i> See Preview</a>
                      &nbsp
                      <a class="disabled btn btn-md btn-danger" id="unsched-cmpgn-btn" data-toggle="modal" data-target="#unscheduleModal"><i class="fa fa-trash-o"></i> Unschedule Campaign</a><th>
                    </tr>
                  </tfoot>
                </table>
              </div>
  ...
  <div class="example-modal">
    <div class="modal" id="unscheduleModal">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Unschedule Campaign</h4>
          </div>
          <div class="modal-body">
            <p id="unsched-msg">Are you sure you want to want to unschedule this campaign?</p>
            <div class='alert alert-success hidden' id="unsched-success">
              <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Campaign has been Unscheduled!
            </div>
            <div class='alert alert-danger hidden' id="unsched-error">
          ...
          <div class="modal-footer">
            ...
            <a id="btn-unshed-cmpgn" class="btn btn-primary">Unschedule</a>
          </div>
        </div>
      </div>
    </div>
