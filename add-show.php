...
include 'includes/create-show.php'
        ...
        <div class="col-sm-12 col-md-7">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Show</h3>
            </div>
            <form class="form-horizontal" name="permissionForm" method="post">
              <div class="box-body">
                ...
                <div class="form-group has-feedback">
                  <label for="inputshname" class="col-sm-3 control-label">Show Name</label>
                  <div class="input-group input-append col-sm-9">
                    <input type="text" class="form-control" id="showname" name="showname" placeholder="Name of Show" required>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group has-feedback">
                  <label for="inputshtime" class="col-sm-3 control-label">Show Time</label>
                  <div class="input-group input-append date col-sm-9">
                    <input type="text" class="form-control" id="showtime" name="showtime" placeholder="Time" required>
                    <span class="glyphicon glyphicon-time form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group has-feedback">
                  <label for="inputshdate" class="col-sm-3 control-label">Show Date</label>
                  <div class="input-group input-append col-sm-9">
                    <input type="date" class="form-control" id="showdate" name="showdate" placeholder="Date" required>
                    <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group has-feedback">
                  <label for="inputticket" class="col-sm-3 control-label">Total Comps</label>
                  <div class="input-group input-append col-sm-9">
                    <input type="number" min="0" class="form-control" id="tickets" name="tickets" placeholder="No. of Comps" required>
                    <span class="glyphicon glyphicon-bullhorn form-control-feedback"></span>
                  </div>
                </div>
              </div>
              <div class="box-footer">
                <a href="shows.php" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>
...
<!-- datetimepicker (NEEDS TO BE IN A SEPARATE MODULE)-->
