          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                <a href="add-contact.php" class="btn btn-block btn-success btn-md"><i class="fa fa-plus"></i> Add New</a>
              </div>
            </div>
            <!-- /.box-header -->
            <?php if(isset($msg)){ echo $msg;}?> 
            <div class="box-body table-responsive">
              <table id="contacts-list" class="table table-hovered display" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th>ID</th>
                    <th>Email</th>
                ...
                <tfoot>
                  <tr>
                    <th></th>
                    <th><a class="disabled btn btn-md btn-warning" id="edit-contact-btn"><i class="fa fa-edit"></i> Edit </a>
                    &nbsp 
                    <a class="disabled btn btn-md btn-danger" id="delete-contact-btn" data-toggle="modal" data-target="#deletecontactModal"><i class="fa fa-trash-o"></i> Delete</a>
                    </th>
                  </tr>
                </tfoot>
              </table>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="contact-rmv-msg">Are you sure you want to want to delete this contact?</p>
            <div class='alert alert-success hidden' id="contact-rmv-success">
              <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Contact Sucessfully Removed!
            </div>
            <div class='alert alert-danger hidden' id="contact-rmv-error">
          ...
          <div class="modal-footer">
            ...
            <a id="btn-delete-contact" class="btn btn-primary">Delete</a>
          </div>
        </div>
      </div>
    </div>
