...
<div class="wrapper">
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Unscheduled Email Campaigns</h3>
              <div class="box-tools pull-right">
                <a href="add-new-campaign.php" class="btn btn-block btn-success btn-md"><i class="fa fa-plus"></i> Create New Campaign</a>
              </div>
            </div>
            <div class="box-body">
              <div class="table-responsive">
                <table id="templates-list" class="table table-hovered display" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th>ID</th>
                  ...
                  <tfoot>
                    <tr>
                      <th></th>
                      <th><a href="#" target="_blank" class="disabled btn btn-md btn-info" id="preview-template"><i class="fa fa-picture-o"></i> See Preview</a>
                      &nbsp
                      <a class="disabled btn btn-md btn-warning" id="edit-cmpgn-btn"><i class="fa fa-edit"></i> Edit Campaign</a>
                      &nbsp
                      <a class="disabled btn btn-md btn-danger" id="delete-cmpgn-btn" data-toggle="modal" data-target="#deleteCampaignModal"><i class="fa fa-trash-o"></i> Delete Campaign</a><th>
                    </tr>
                  </tfoot>
                </table>
              </div>
  ...
  <div class="example-modal">
    <div class="modal" id="deleteCampaignModal">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="cmpgn-rmv-msg">Are you sure you want to want to delete this campaign?</p>
            <div class='alert alert-success hidden' id="cmpgn-rmv-success">
              <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Campaign Successfully Removed!
            </div>
            <div class='alert alert-danger hidden' id="cmpgn-rmv-error">
          ...
          <div class="modal-footer">
            ...
            <a id="btn-delete-cmpgn" class="btn btn-primary">Delete</a>
          </div>
        </div>
      </div>
    </div>
...
<!-- Moment Js-->
<script src="node_modules/admin-lte/plugins/moment/min/moment.min.js"></script>
<!-- FastClick -->
...
<!-- Sparkline -->
<script src="node_modules/admin-lte/plugins/jscolor/jscolor.min.js"></script>
<!-- DataTables -->
