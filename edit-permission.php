...
include 'includes/update-permissions.php';
            ...
            <form class="form-horizontal" name="permissionForm" method="post" >
              <div class="box-body">
                ...
                <div class="form-group has-feedback" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="<?php echo $pname;?>" required>
                ...
                <div class="form-group has-feedback">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="slug" name="slug" placeholder="Slug" value="<?php echo $slug;?>" required>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="3" id="description" name="description" placeholder="Description"><?php echo $desc;?></textarea>
                  </div>
                </div>
              </div>
              <div class="box-footer">
                <a href="permissions.php" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>
