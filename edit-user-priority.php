...
include ('includes/update-user-priority.php');
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit User Priority</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-sm-12 col-md-7">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit This User's Priority</h3>
            </div>
