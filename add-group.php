        ...
        <div class="col-xs-12 col-md-7">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Add Group ( Keep names the same for both fields )</h3>
            </div>
            <form id="create_subscriber_form" method="post">
              <div class="box-body">
                <?php
                  if(isset($msg)){
                   echo $msg;
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="group_name" class="form-control" id="group_name" placeholder="i.e. Broker ">
                  </div>
                </div>
                <div class="form-group col-md-6">
                  <label for="name" class="control-label">Priority Group:</label>
                  <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-tags"></i></span>
                    <input type="text" name="group_prty" class="form-control" id="group_prty" placeholder="i.e. Broker ">
                  </div>
                </div>
                <!-- <div class="form-group col-md-6">
              ...
              <div class="box-footer">
                <a href="groups.php" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>
                <a id="create_new_contact" class="btn btn-primary pull-right">Add Group</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
