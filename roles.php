          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                <a href="add-role.php" class="btn btn-block btn-success btn-md"><i class="fa fa-plus"></i> Add New</a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="roles-list" class="display" cellspacing="0" width="100%">
                  <thead>
                      <tr>
                          <th>ID</th>
                          <th>Name</th>
                  ...
                  <tfoot>
                    <tr>
                      <th></th>
                      <th><a class="disabled btn btn-md btn-warning" id="edit-roles-btn"><i class="fa fa-edit"></i> Edit </a>
                      &nbsp
                      <a class="disabled btn btn-md btn-danger" id="delete-roles-btn" data-toggle="modal" data-target="#deleteRoleModal"><i class="fa fa-trash-o"></i> Delete</a><th>
                    </tr>
                  </tfoot>
              </table>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="role-rmv-msg">Are you sure you want to want to delete this role?</p>
            <div class='alert alert-success hidden' id="role-rmv-success">
              <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Role Sucessfully Removed!
            </div>
            <div class='alert alert-danger hidden' id="role-rmv-error">
          ...
          <div class="modal-footer">
            ...
            <a id="btn-delete-role" class="btn btn-primary">Delete</a>
          </div>
        </div>
      </div>
    </div>
