          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                <a href="add-user.php" class="btn btn-block btn-success btn-md"><i class="fa fa-plus"></i> Add New</a>
              </div>
            </div>
            <!-- /.box-header -->
            <?php if(isset($msg)){ echo $msg;}?> 
            <div class="box-body table-responsive">
              <table id="user-list" class="table table-hovered display" cellspacing="0" width="100%">
                  <thead>
                      <tr>
                          <th>ID</th>
                          <th>Name</th>
                  ...
                  <tfoot>
                    <tr>
                      <th></th>
                      <th><a class="disabled btn btn-md btn-warning" id="edit-user-btn"><i class="fa fa-edit"></i> Edit </a>
                      &nbsp 
                      <a class="disabled btn btn-md btn-danger" id="delete-user-btn" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash-o"></i> Delete</a>
                      <th></th>
                    </tr>
                  </tfoot>
              </table>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="usr-rmv-msg">Are you sure you want to want to delete this user?</p>
            <div class='alert alert-success hidden' id="usr-rmv-success">
              <span class='glyphicon glyphicon-info-sign'></span> &nbsp; User Sucessfully Removed!
            </div>
            <div class='alert alert-danger hidden' id="usr-rmv-error">
          ...
          <div class="modal-footer">
            ...
            <a id="btn-delete-user" class="btn btn-primary">Delete</a>
          </div>
        </div>
      </div>
    </div>
