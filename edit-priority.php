...
include 'includes/update-priority.php';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Priority</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <form class="form-horizontal" name="permissionForm" method="post" >
              <div class="box-body">
                ...
                <div class="form-group has-feedback" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="<?php echo $prtyname;?>" required>
              ...
              <div class="box-footer">
                <a href="priorities.php" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>
