      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/group.php"><i class="fa fa-circle-o"></i>Contact Groups</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total Comps</span>
              <span class="info-box-number" id="total-comps">190</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Comps Given</span>
...
<!-- jQuery UI 1.11.4 -->
<script src="node_modules/admin-lte/https://code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
<!-- FastClick -->
...
<!-- ChartJS 1.1.1 -->
<script src="node_modules/admin-lte/plugins/chartjs/Chart.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="node_modules/admin-lte/dist/js/pages/dashboard2.js"></script>
