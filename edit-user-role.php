...
include ('includes/update-user-role.php');
        ...
        <div class="col-sm-12 col-md-7">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit This User's Role</h3>
            </div>
            <form class="form-horizontal" name="permissionForm" method="post" >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <?php 
                    $user_role = new USER();
                    $stmt = $user_role->runQuery("SELECT id, name FROM roles");
                    $stmt->execute();
                    $stmt->bind_result($roleid, $name);
                    while($stmt->fetch()) {
                      echo "<div class=\"radio\">";
                      echo "<label>";
                      echo "<input type=\"radio\" name=roles[] id=role_no.$roleid value=$roleid>$name";
                      echo "</label>";
                      echo "</div>";
                    }
                    $stmt->close();
