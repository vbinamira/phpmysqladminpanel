...
<head>
  ...
  <link rel="stylesheet" href="node_modules/admin-lte/dist/css/style.css">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            <form class="form-horizontal" name="permissionForm" method="post" >
              <div class="box-body">
                <?php
                  if(isset($msg)){
                   echo $msg;
                ...
                ?>                    
                <?php if($id !='') { ?>
                <input type="hidden" name="id" class="form-control" value="<?php echo $id;?>" id="user-id">
                <?php } ?>
                <div class="form-group has-feedback" >
                  <label for="inputname" class="col-sm-2 control-label">Name</label>
                  <div class="col-sm-10">
                    <input name="name" type="text" class="form-control" placeholder="Full name" value="<?php echo $uname;?>" required>
                ...
                <div class="form-group has-feedback">
                  ...
                  <div class="col-sm-10">
                    <input name="company_name" id="company_name" type="text" class="form-control" placeholder="Name of Company" value="<?php echo $cmpnyname;?>">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group has-feedback">
                  ...
                  <div class="col-sm-10">
                    <input name="title" id="title" type="text" class="form-control" placeholder="Job Title" value="<?php echo $title;?>">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                  </div>
                </div>
                <div class="form-group has-feedback">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" id="description" name="description" placeholder="Optional" rows="3"><?php echo $desc;?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputemail" class="col-sm-2 control-label">Priority List (Click to Edit)</label>
                  <div class="col-sm-10">
                    <?php 
                    $user_id = $_GET['id'];
                    $edit_role = new USER();
                    $edit_role->getUserPrioritybyID($user_id);
                  ?>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputrole" class="col-sm-2 control-label">Role (Click to Edit)</label>
                  <div class="col-sm-10">
                  <?php 
                    $user_id = $_GET['id'];
                    $edit_priority = new USER();
                    $edit_role->getUserRolebyID($user_id);
                  ?>
                  </div>
                </div>
              </div>
              <div class="box-footer">
                <a href="user-list.php" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>
                <button type="submit" id="submit"  name="change-info" class="btn btn-primary pull-right">Save</button>
              </div>
            </form>
          </div>
        </div>
