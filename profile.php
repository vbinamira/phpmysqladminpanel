...
if(isset($_POST['change-pass']))
{
    ...
    if($newpass == '' && $cpass == '') {
       $msgpass = "<div class='alert alert-danger'>
        <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Please fill out both fields !
      </div>";
    } 
    else 
    {
      ...
      {
        $newpass= md5($newpass);
        $stmt = $user_role->runQuery("UPDATE users SET password = ?, updated_at = now() WHERE id = ?");
...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="node_modules/admin-lte/plugins/datatables/datatables/media/css/jquery.dataTables.min.css">
  <!-- Theme style -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="http://placeholdit.imgix.net/~text?txtfont=monospace,bold&bg=DD4B39&txtclr=ffffff&txt=A&w=45&h=45&txtsize=16" alt="User profile picture">

              <h3 class="profile-username text-center"><?php echo $name; ?></h3>

              <p class="text-muted text-center"><?php echo $title; ?></p>
              <!-- Use this for list of comps and other things that may be neccessary-->
        ...
        <!-- /.col -->
        <!-- Show Logs in here as well as other relavant info of the user -->
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#chngpass" data-toggle="tab">Change Password</a></li>
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="chngpass">
                ...
                echo $id;?>">
                  ...
                  <div class="form-group">
                    <label for="cnfmpwd" class="col-sm-3 control-label">Confirm Password:</label>
                    <div class="col-sm-9">
                      <input type="password" name="cnfmpwd" class="form-control" id="cnfmpwd" placeholder="Confirm Password">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-10">
                      <button name="change-pass" class="btn btn-danger">Change Password</button>
                    </div>
                  </div>
                </form>
              </div>
...
<!-- DataTables -->
<script src="node_modules/admin-lte/plugins/datatables/datatables/media/js/jquery.dataTables.min.js"></script>
